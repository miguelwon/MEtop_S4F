...
C[57]=+S[4]*(S[0]*(2*(S[0]+S[2])));
C[56]=+8*S[4];
C[55]=+S[1]*(S[0]*(4*(S[2]+S[1])));
C[54]=+S[0]*(16*(S[0]+S[1]));
C[53]=+S[0]*(16*(S[2]-S[1]));
C[52]=+S[1]*(S[0]*(8*(S[0]+S[2])));
C[51]=+32*S[0]+16*S[1];
C[50]=+S[0]*(8*(S[0]+S[2]));
C[49]=+S[3]*(S[1]*(4*(S[0]-S[2])));
C[48]=+48*S[0]*S[1];
C[47]=+S[0]*(4*(S[0]*(S[0]-S[2]+S[1])-S[2]*S[1]));
C[46]=+S[0]*(8*(S[0]-S[2]));
...
C[38]=+32*S[0]*S[1];
C[37]=+32*S[0];
C[36]=+S[1]*(S[0]*(8*(S[0]-S[2])));
C[35]=+S[1]*(16*(S[0]-S[2]));
C[34]=+32*S[1];
C[33]=+8*S[3]*S[2]*S[1];
C[32]=+16*S[0]*S[2]*S[1];
C[31]=+8*(S[0]*(S[0]-S[2]+S[1])-S[2]*S[1]);
C[30]=+16*(S[0]-S[2]);
C[29]=+16*(S[0]-S[1]);
C[28]=+S[2]*(S[0]*(8*(S[0]+S[1])));
C[27]=+S[0]*(8*(S[2]-S[1]));
C[26]=+16*S[0];
C[25]=+8*S[0]*S[2];
C[24]=+16*S[0]*S[2];
C[23]=+S[1]*(S[0]*(4*(S[0]+S[2])));
C[22]=+S[3]*(S[1]*(2*(S[0]-S[2])));
C[21]=+24*S[0]*S[1];
C[20]=+8*S[3]*S[1];
C[19]=+S[1]*(S[0]*(8*S[0]-4*S[2]));
C[18]=+16*S[0]*S[1];
C[17]=+S[4]*(S[0]*(2*(S[0]-S[2])));
C[16]=+S[1]*(4*(S[0]*(S[0]-S[2]+S[1])-S[2]*S[1]));
C[15]=+S[1]*(8*(S[0]-S[1]));
C[14]=+S[1]*(S[0]*(4*(S[0]-S[2])));
C[13]=+S[1]*(8*(S[0]-S[2]));
C[12]=+16*S[1];
C[11]=+4*S[0]*S[4];
C[10]=+2*S[3]*S[2]*S[4];
C[9]=+S[1]*(S[2]*(S[0]*(4*(S[0]+S[1]))));
...
tmp[1]=+DP[5]*(C[6]*(DP[6]*(DP[12]*(DP[2]+DP[4]+DP[8]+DP[9])+DP[13]*(DP[2]+
 ...
 DP[0])-C[63])+DP[14]*(C[11]*(DP[0]-DP[6])+C[17]+C[14]*DP[5]+C[8]*DP[7])+
...
tmp[2]=+DP[12]*(S[1]*(DP[3]*(DP[6]*(C[26]*(S[1]+DP[6])+C[37]*DP[7]-C[42])+
 DP[7]*(C[26]*(S[1]+DP[7])-C[39])+C[47]-C[46]*S[1])+DP[4]*(S[1]*(C[24]-
 ...
 C[2]*(DP[8]-DP[2])+C[4]*(DP[9]-DP[4]))+DP[7]*(DP[1]*(C[40]+C[6]*DP[5]-
...
tmp[3]=+DP[7]*(DP[5]*(C[6]*(DP[6]*(DP[13]*(DP[1]-DP[2]+DP[3]-DP[4])+DP[10]*(
 ...
 C[14]*(DP[5]-S[1])+C[66]-C[60]*DP[7])+DP[6]*(C[55]*DP[11]-C[4]*DP[14])+
 DP[13]*(C[14]*(-DP[1]-DP[3]))+C[9]*(DP[14]-DP[11]))+DP[13]*(DP[1]*(DP[6]*(
 C[6]*(-S[1]-DP[6])+C[20]-C[18]*DP[7])+DP[7]*(C[6]*(-S[1]-DP[7])+C[19])+
 C[14]*S[1]-C[22])+DP[2]*(S[1]*(C[6]*DP[6]-C[2])+C[7]-C[4]*DP[6]-C[2]*
...
R=+S[1]*(DP[0]*(S[1]*(DP[5]*(C[12]*(DP[13]*(DP[6]*(DP[1]+DP[2]+DP[3]+DP[4])+
 ...
 DP[4])+DP[10]*(DP[0]-S[1]+DP[5])+DP[11]*(DP[5]-S[1]))+DP[14]*(C[13]*(S[1]-
 DP[5])+C[6]*(DP[6]+DP[7])-C[16]-C[15]*DP[0])+DP[10]*(C[69]-C[68]*DP[6]-
