...
R=+DP[5]*(C[2]*(DP[0]*(DP[8]*(-DP[12]-DP[13])+DP[9]*(-DP[12]-DP[13])+DP[14]*
 ...
 DP[10]*(S[1]-DP[5]))+C[3]*DP[14]-C[8]*DP[10])+C[3]*(DP[10]*DP[7]-DP[11]*
 DP[6]))+S[1]*(DP[12]*(DP[0]*(S[1]*(C[6]*DP[3]-C[5]*DP[9])+C[4]*(DP[8]-
 DP[3])+C[2]*DP[9]-C[7]*DP[1])+DP[6]*(DP[4]*(C[5]*S[1]-C[2])-C[4]*DP[2])+
 DP[7]*(DP[3]*(C[2]-C[5]*S[1])+C[4]*DP[1]))+DP[13]*(C[2]*(DP[7]*DP[1]-DP[6]*
 DP[2]+DP[8]*DP[0])-C[4]*DP[1]*DP[0]));
R*=(N/D)*Q2[1]*Q2[2];
 if(cb_coeff_out)
 {
