...
R=+DP[0]*(DP[5]*(C[2]*(DP[6]*(DP[12]*(DP[1]+DP[2]+DP[3]+DP[4])+DP[13]*(
 ...
 DP[0])+C[11]*(DP[10]+DP[11])-C[5]*DP[14])+S[1]*(DP[12]*(S[1]*(8*(DP[3]*(
 DP[6]+DP[7])+DP[4]*(DP[6]+DP[7])-DP[9]*DP[0])+C[9]*(-DP[3]-DP[4])+C[7]*
 DP[9])+C[8]*(DP[1]*(-DP[6]-DP[7])+DP[2]*(-DP[6]-DP[7])+DP[8]*DP[0])+C[2]*(
 DP[3]*(-DP[6]-DP[7])+DP[4]*(-DP[6]-DP[7])+DP[9]*DP[0])+C[6]*(DP[3]+DP[4]-
 DP[8])+C[10]*(DP[1]+DP[2])-C[3]*DP[9])+DP[13]*(C[2]*(DP[1]*(-DP[6]-DP[7])+
