...
C[37]=+S[4]*(S[1]*(V[35]*(S[1]*(8*V[36]-4*V[35])+S[0]*(2*V[36]+V[35]))+S[2]*
 (S[0]-4*S[1])));
...
C[31]=+S[5]*(S[1]*(V[35]*(S[1]*(32*V[36]-16*V[35])+S[0]*(8*V[36]+4*V[35]))+
 S[2]*(4*S[0]-16*S[1])));
C[30]=+S[1]*(V[35]*(S[1]*(32*V[36]-16*V[35])+S[0]*(8*V[36]+4*V[35]))+S[2]*(
 4*S[0]-16*S[1]));
...
C[21]=+S[1]*(V[35]*(8*V[35]-16*V[36])+8*S[2]);
...
C[15]=+S[5]*(S[1]*(V[35]*(S[1]*(16*V[36]-8*V[35])+S[0]*(4*V[36]+2*V[35]))+
 S[2]*(2*S[0]-8*S[1])));
...
C[10]=+S[4]*(S[1]*(V[35]*(2*V[35]-4*V[36])+2*S[2]));
C[9]=+S[5]*(S[1]*(S[0]*(V[35]*(8*V[36]+4*V[35])+4*S[2])));
C[8]=+S[5]*(S[1]*(V[35]*(4*V[35]-8*V[36])+4*S[2]));
C[7]=+S[4]*(S[1]*(V[35]*(4*V[35]-8*V[36])+4*S[2]));
C[6]=+S[5]*(S[1]*(V[35]*(8*V[35]-16*V[36])+8*S[2]));
C[5]=+S[4]*(S[0]*(V[35]*(2*V[36]+V[35])+S[2]));
C[4]=+S[5]*(S[0]*(V[35]*(4*V[36]+2*V[35])+2*S[2]));
