...
S[1]=V[11]*V[11];
S[2]=V[8]*V[8];
C[9]=+S[2]*(S[1]*(V[35]*(8*V[36]+4*V[35])+4*S[0]));
C[8]=+S[2]*(V[35]*(8*V[35]-16*V[36])+8*S[0]);
C[7]=+S[1]*(V[35]*(8*V[36]+4*V[35])+4*S[0]);
C[6]=+V[35]*(8*V[35]-16*V[36])+8*S[0];
S[3]=V[8]*V[8]*V[8]*V[8];
C[5]=+S[3]*(S[1]*(V[35]*(2*V[36]+V[35])+S[0]));
C[4]=+S[3]*(V[35]*(2*V[35]-4*V[36])+2*S[0]);
C[3]=+S[2]*(S[1]*(V[35]*(4*V[36]+2*V[35])+2*S[0]));
