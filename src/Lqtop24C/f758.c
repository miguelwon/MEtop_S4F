...
S[1]=V[11]*V[11];
S[2]=V[8]*V[8]*V[8]*V[8];
C[18]=+S[2]*(S[1]*(V[35]*(4*V[36]+2*V[35])+2*S[0]));
S[3]=V[8]*V[8];
C[17]=+S[3]*(S[1]*(V[35]*(16*V[36]+8*V[35])+8*S[0]));
C[16]=+S[1]*(V[35]*(16*V[36]+8*V[35])+8*S[0]);
C[15]=+S[3]*(V[35]*(32*V[35]-64*V[36])+32*S[0]);
C[14]=+S[1]*(V[35]*(8*V[36]+4*V[35])+4*S[0]);
C[13]=+V[35]*(8*V[35]-16*V[36])+8*S[0];
C[12]=+V[35]*(32*V[35]-64*V[36])+32*S[0];
C[11]=+V[35]*(16*V[35]-32*V[36])+16*S[0];
C[10]=+S[3]*(S[1]*(V[35]*(8*V[36]+4*V[35])+4*S[0]));
...
C[4]=+S[3]*(V[35]*(16*V[35]-32*V[36])+16*S[0]);
