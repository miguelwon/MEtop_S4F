...
S[1]=V[37]*V[37];
S[2]=V[8]*V[8]*V[8]*V[8];
C[23]=+S[2]*(V[9]*(S[1]*(6*V[11]+2*V[9])+S[0]*(6*V[11]-2*V[9])));
S[3]=V[11]*V[11];
S[4]=V[9]*V[9];
C[22]=+S[2]*(2*(S[4]*(S[1]-S[0])+S[3]*(S[0]-S[1])));
S[5]=V[8]*V[8];
C[21]=+S[5]*(V[9]*(S[1]*(24*V[11]+8*V[9])+S[0]*(24*V[11]-8*V[9])));
C[20]=+V[9]*(S[1]*(24*V[11]+8*V[9])+S[0]*(24*V[11]-8*V[9]));
C[19]=+S[5]*(8*(S[4]*(S[1]-S[0])+S[3]*(S[0]-S[1])));
C[18]=+8*(S[4]*(S[1]-S[0])+S[3]*(S[0]-S[1]));
C[17]=+S[5]*(V[9]*(S[1]*(-24*V[11]-4*V[9])+S[0]*(4*V[9]-24*V[11]))+S[3]*(4*(
 S[0]-S[1])));
C[16]=+S[5]*(32*(S[0]-S[1]));
C[15]=+V[9]*(S[1]*(-24*V[11]-4*V[9])+S[0]*(4*V[9]-24*V[11]))+S[3]*(4*(S[0]-
 S[1]));
C[14]=+8*(S[0]-S[1]);
C[13]=+32*(S[0]-S[1]);
C[12]=+16*(S[0]-S[1]);
C[11]=+S[5]*(V[9]*(S[1]*(12*V[11]+4*V[9])+S[0]*(12*V[11]-4*V[9])));
C[10]=+S[5]*(4*(S[4]*(S[1]-S[0])+S[3]*(S[0]-S[1])));
C[9]=+S[2]*(V[9]*(S[1]*(-6*V[11]-V[9])+S[0]*(V[9]-6*V[11]))+S[3]*(S[0]-
 S[1]));
C[8]=+S[2]*(2*(S[0]-S[1]));
C[7]=+S[5]*(V[9]*(S[1]*(-12*V[11]-2*V[9])+S[0]*(2*V[9]-12*V[11]))+S[3]*(2*(
 S[0]-S[1])));
C[6]=+S[5]*(4*(S[0]-S[1]));
C[5]=+S[2]*(8*(S[0]-S[1]));
C[4]=+S[5]*(16*(S[0]-S[1]));
