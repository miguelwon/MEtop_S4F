...
C[39]=+S[4]*(S[3]*(V[35]*(S[1]*(-2*V[36]-V[35])+S[0]*(2*V[35]-4*V[36]))+
 S[2]*(2*S[0]-S[1])));
C[38]=+S[4]*(S[0]*(V[35]*(S[1]*(-2*V[36]-V[35])+S[0]*(4*V[35]-8*V[36]))+
 S[2]*(4*S[0]-S[1])));
...
C[34]=+S[3]*(V[35]*(S[1]*(-8*V[36]-4*V[35])+S[0]*(8*V[35]-16*V[36]))+S[2]*(
 8*S[0]-4*S[1]));
C[33]=+S[5]*(S[0]*(V[35]*(S[1]*(-8*V[36]-4*V[35])+S[0]*(16*V[35]-32*V[36]))+
 S[2]*(16*S[0]-4*S[1])));
C[32]=+S[0]*(V[35]*(S[1]*(-8*V[36]-4*V[35])+S[0]*(16*V[35]-32*V[36]))+S[2]*(
 16*S[0]-4*S[1]));
