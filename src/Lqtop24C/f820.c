...
S[2]=V[38]*V[38];
S[3]=V[8]*V[8]*V[8]*V[8];
C[20]=+S[3]*(V[37]*(S[1]*(V[37]-2*V[38])+S[0]*(2*V[38]+V[37]))+S[2]*(S[0]+
 S[1]));
C[19]=+S[3]*(S[1]*(V[37]*(S[1]*(2*V[38]-V[37])+S[0]*(2*V[38]+V[37]))+S[2]*(
 S[0]-S[1])));
S[4]=V[8]*V[8];
C[18]=+S[4]*(V[37]*(S[1]*(4*V[37]-8*V[38])+S[0]*(8*V[38]+4*V[37]))+S[2]*(4*(
 S[0]+S[1])));
C[17]=+V[37]*(S[1]*(4*V[37]-8*V[38])+S[0]*(8*V[38]+4*V[37]))+S[2]*(4*(S[0]+
 S[1]));
C[16]=+S[4]*(S[1]*(V[37]*(S[1]*(8*V[38]-4*V[37])+S[0]*(8*V[38]+4*V[37]))+
 S[2]*(4*(S[0]-S[1]))));
C[15]=+S[1]*(V[37]*(S[1]*(8*V[38]-4*V[37])+S[0]*(8*V[38]+4*V[37]))+S[2]*(4*(
 S[0]-S[1])));
C[14]=+S[4]*(S[1]*(V[37]*(16*V[37]-32*V[38])+16*S[2]));
C[13]=+S[4]*(V[37]*(8*V[37]-16*V[38])+8*S[2]);
C[12]=+S[1]*(V[37]*(16*V[37]-32*V[38])+16*S[2]);
C[11]=+V[37]*(8*V[37]-16*V[38])+8*S[2];
C[10]=+S[1]*(V[37]*(8*V[37]-16*V[38])+8*S[2]);
C[9]=+S[4]*(V[37]*(S[1]*(2*V[37]-4*V[38])+S[0]*(4*V[38]+2*V[37]))+S[2]*(2*(
 S[0]+S[1])));
C[8]=+S[4]*(S[1]*(V[37]*(S[1]*(4*V[38]-2*V[37])+S[0]*(4*V[38]+2*V[37]))+
 S[2]*(2*(S[0]-S[1]))));
C[7]=+S[3]*(S[1]*(V[37]*(4*V[37]-8*V[38])+4*S[2]));
C[6]=+S[4]*(S[1]*(V[37]*(8*V[37]-16*V[38])+8*S[2]));
C[5]=+S[3]*(V[37]*(2*V[37]-4*V[38])+2*S[2]);
C[4]=+S[4]*(V[37]*(4*V[37]-8*V[38])+4*S[2]);
C[3]=+S[3]*(S[1]*(V[37]*(2*V[37]-4*V[38])+2*S[2]));
C[2]=+S[4]*(S[1]*(V[37]*(4*V[37]-8*V[38])+4*S[2]));
S[5]=V[14]*V[14];
S[6]=V[2]*V[2]*V[2]*V[2];
C[1]=+3*S[5]*S[6];
S[7]=V[52]*V[52];
...
REAL F820_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
         G                 c      !  c                 G             
       -1---@==============>======!==>==============@---1-           
