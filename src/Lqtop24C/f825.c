...
S[2]=V[38]*V[38];
S[3]=V[8]*V[8]*V[8]*V[8];
C[25]=+S[3]*(V[37]*(S[1]*(4*V[38]-2*V[37])+S[0]*(6*V[37]-4*V[38]))+S[2]*(6*
 S[0]-2*S[1]));
S[4]=V[11]*V[11]*V[11]*V[11];
C[24]=+S[3]*(S[1]*(V[37]*(S[1]*(V[37]-2*V[38])+S[0]*(-4*V[38]-2*V[37]))+
 S[2]*(S[1]-2*S[0]))+S[4]*(V[37]*(V[37]-2*V[38])+S[2]));
S[5]=V[37]*V[37];
C[23]=+S[3]*(S[1]*(V[37]*(8*V[38]-4*V[37])-4*S[2])+S[0]*(8*(S[2]+S[5])));
S[6]=V[8]*V[8];
C[22]=+S[6]*(S[1]*(V[37]*(S[1]*(4*V[37]-8*V[38])+S[0]*(-16*V[38]-8*V[37]))+
 S[2]*(4*S[1]-8*S[0]))+S[4]*(V[37]*(4*V[37]-8*V[38])+4*S[2]));
C[21]=+S[1]*(V[37]*(S[1]*(4*V[37]-8*V[38])+S[0]*(-16*V[38]-8*V[37]))+S[2]*(
 4*S[1]-8*S[0]))+S[4]*(V[37]*(4*V[37]-8*V[38])+4*S[2]);
C[20]=+S[6]*(V[37]*(S[1]*(16*V[38]-8*V[37])+S[0]*(24*V[37]-16*V[38]))+S[2]*(
 24*S[0]-8*S[1]));
C[19]=+S[6]*(S[1]*(V[37]*(32*V[38]-16*V[37])-16*S[2])+S[0]*(32*(S[2]+
 S[5])));
C[18]=+V[37]*(S[1]*(16*V[38]-8*V[37])+S[0]*(24*V[37]-16*V[38]))+S[2]*(24*
 S[0]-8*S[1]);
C[17]=+S[1]*(V[37]*(32*V[38]-16*V[37])-16*S[2])+S[0]*(32*(S[2]+S[5]));
...
C[10]=+S[6]*(S[1]*(V[37]*(S[1]*(2*V[37]-4*V[38])+S[0]*(-8*V[38]-4*V[37]))+
 S[2]*(2*S[1]-4*S[0]))+S[4]*(V[37]*(2*V[37]-4*V[38])+2*S[2]));
C[9]=+S[6]*(V[37]*(S[1]*(8*V[38]-4*V[37])+S[0]*(12*V[37]-8*V[38]))+S[2]*(12*
 S[0]-4*S[1]));
C[8]=+S[6]*(S[1]*(V[37]*(16*V[38]-8*V[37])-8*S[2])+S[0]*(16*(S[2]+S[5])));
C[7]=+S[3]*(V[37]*(S[1]*(4*V[38]-2*V[37])+S[0]*(4*V[38]+2*V[37]))+S[2]*(2*(
 S[0]-S[1])));
C[6]=+S[6]*(V[37]*(S[1]*(8*V[38]-4*V[37])+S[0]*(8*V[38]+4*V[37]))+S[2]*(4*(
 S[0]-S[1])));
C[5]=+S[3]*(S[0]*(V[37]*(4*V[37]-8*V[38])+4*S[2]));
C[4]=+S[3]*(V[37]*(4*V[37]-8*V[38])+4*S[2]);
