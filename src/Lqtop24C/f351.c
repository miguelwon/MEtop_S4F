...
C[64]=+S[3]*(S[4]*(S[2]-S[0]));
C[63]=+S[1]*(S[2]*(2*(S[2]*(S[2]-S[0]+S[1])-S[0]*S[1])));
C[62]=+S[1]*(S[2]*(8*S[2]+12*S[1]));
C[61]=+S[1]*(24*S[2]+8*S[1]);
C[60]=+S[3]*(S[2]*(4*S[2]-2*S[0]));
C[59]=+S[1]*(S[2]*(4*(S[1]-S[0])+8*S[2]));
...
C[54]=+S[2]*(16*(S[0]-S[1]));
C[53]=+S[2]*(16*(S[2]+S[1]));
C[52]=+S[4]*(S[1]*(4*(S[2]-S[0])));
C[51]=+48*S[2]*S[1];
C[50]=+S[2]*(4*(S[2]*(S[2]-S[0]+S[1])-S[0]*S[1]));
C[49]=+S[2]*(8*(S[2]-S[0]));
C[48]=+S[2]*(16*S[2]+24*S[1]);
C[47]=+48*S[2]+16*S[1];
C[46]=+S[1]*(S[2]*(16*S[2]-8*S[0]));
C[45]=+S[2]*(8*(S[1]-S[0])+16*S[2]);
C[44]=+S[1]*(S[2]*(8*(S[2]+S[0])));
C[43]=+S[2]*(8*(S[2]+S[0]));
C[42]=+32*S[2]+16*S[1];
C[41]=+16*S[4]*S[1];
C[40]=+S[2]*(8*(S[0]+S[1]));
...
C[38]=+32*S[2]*S[1];
C[37]=+32*S[2];
C[36]=+S[1]*(S[2]*(8*(S[2]-S[0])));
C[35]=+S[1]*(16*(S[2]-S[0]));
C[34]=+32*S[1];
C[33]=+8*S[4]*S[0]*S[1];
C[32]=+16*S[2]*S[0]*S[1];
C[31]=+8*(S[2]*(S[2]-S[0]+S[1])-S[0]*S[1]);
C[30]=+16*(S[2]-S[0]);
C[29]=+16*(S[2]-S[1]);
C[28]=+S[0]*(S[2]*(8*(S[2]+S[1])));
C[27]=+S[2]*(8*(S[0]-S[1]));
C[26]=+16*S[2]*S[0];
C[25]=+16*S[2];
C[24]=+8*S[2]*S[0];
C[23]=+S[4]*(S[1]*(2*(S[2]-S[0])));
C[22]=+24*S[2]*S[1];
C[21]=+S[1]*(S[2]*(8*S[2]-4*S[0]));
C[20]=+S[1]*(S[2]*(4*(S[2]+S[0])));
C[19]=+8*S[4]*S[1];
C[18]=+16*S[2]*S[1];
C[17]=+S[3]*(S[2]*(2*(S[2]-S[0])));
C[16]=+S[1]*(4*(S[2]*(S[2]-S[0]+S[1])-S[0]*S[1]));
C[15]=+S[1]*(8*(S[2]-S[1]));
C[14]=+S[1]*(S[2]*(4*(S[2]-S[0])));
C[13]=+S[1]*(8*(S[2]-S[0]));
C[12]=+16*S[1];
C[11]=+2*S[4]*S[0]*S[3];
C[10]=+S[1]*(S[0]*(S[2]*(4*(S[2]+S[1]))));
...
tmp[1]=+DP[5]*(C[4]*(DP[7]*(DP[12]*(DP[1]+DP[3]+DP[8]+DP[9])+DP[13]*(DP[1]+
 ...
 DP[0])-C[57])+DP[14]*(C[5]*(DP[0]-DP[7])+C[17]+C[14]*DP[5]+C[9]*DP[6])+
...
tmp[2]=+DP[12]*(S[1]*(DP[4]*(DP[6]*(C[25]*(S[1]+DP[6])+C[37]*DP[7]-C[45])+
 DP[7]*(C[25]*(S[1]+DP[7])-C[39])+C[50]-C[49]*S[1])+DP[3]*(S[1]*(C[26]-
 ...
 C[6]*(DP[8]-DP[1])+C[2]*(DP[9]-DP[3]))+DP[6]*(DP[2]*(C[46]+C[4]*DP[5]-
...
tmp[3]=+DP[6]*(DP[5]*(C[4]*(DP[7]*(DP[13]*(DP[2]-DP[1]-DP[3]+DP[4])+DP[11]*(
 ...
 DP[5]+DP[6])+DP[14]*(DP[5]-S[1]-DP[6]))+DP[11]*(DP[6]*(C[18]*DP[7]-C[59])+
 C[14]*(DP[5]-S[1])+C[63]-C[56]*DP[7])+DP[7]*(C[66]*DP[10]-C[2]*DP[14])+
 DP[13]*(C[14]*(-DP[2]-DP[4]))+C[10]*(DP[14]-DP[10]))+DP[13]*(DP[2]*(DP[6]*(
 C[4]*(-S[1]-DP[6])+C[21]-C[18]*DP[7])+DP[7]*(C[4]*(-S[1]-DP[7])+C[19])+
 C[14]*S[1]-C[23])+DP[1]*(S[1]*(C[4]*DP[7]-C[6])+C[8]-C[6]*DP[6]-C[2]*
...
tmp[4]=+DP[5]*(DP[6]*(DP[0]*(DP[12]*(DP[2]*(C[18]*(-DP[6]-DP[7])+C[19]+C[4]*
 ...
 (DP[12]*(C[6]*(DP[1]+DP[3]-DP[8]-DP[9])+DP[2]*(C[4]*DP[6]-C[21]+C[18]*
 DP[7])+DP[4]*(C[4]*DP[6]-C[21]+C[18]*DP[7]))+DP[13]*(C[6]*(DP[1]+DP[3]-
 DP[8]-DP[9])+DP[2]*(C[4]*DP[6]-C[21]+C[18]*DP[7])+DP[4]*(C[4]*DP[6]-C[21]+
 ...
 DP[5]*(DP[10]-DP[14]))+C[23]*(DP[2]*(DP[12]+DP[13])+DP[4]*(DP[12]+DP[13])-
 DP[11]*DP[5])+C[11]*(DP[10]-DP[14])-C[64]*DP[11]));
R=+S[1]*(DP[0]*(S[1]*(DP[5]*(C[12]*(DP[13]*(DP[6]*(DP[1]+DP[2]+DP[3]+DP[4])+
 ...
 DP[4])+DP[11]*(DP[0]-S[1]+DP[5])+DP[10]*(DP[5]-S[1]))+DP[14]*(C[13]*(S[1]-
 DP[5])+C[4]*(DP[6]+DP[7])-C[16]-C[15]*DP[0])+DP[10]*(C[15]*DP[7]-C[69]-
