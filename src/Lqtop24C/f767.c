...
S[1]=V[11]*V[11];
S[2]=V[8]*V[8]*V[8]*V[8];
C[24]=+S[2]*(S[1]*(V[35]*(2*V[36]+7*V[35])+7*S[0]));
S[3]=V[35]*V[35];
C[23]=+S[2]*(S[1]*(9*(S[0]+S[3])));
C[22]=+S[2]*(V[35]*(8*V[35]-16*V[36])+8*S[0]);
S[4]=V[8]*V[8];
C[21]=+S[4]*(S[1]*(V[35]*(8*V[36]+28*V[35])+28*S[0]));
C[20]=+S[4]*(S[1]*(36*(S[0]+S[3])));
C[19]=+S[1]*(V[35]*(8*V[36]+28*V[35])+28*S[0]);
C[18]=+S[1]*(36*(S[0]+S[3]));
C[17]=+S[4]*(V[35]*(32*V[35]-64*V[36])+32*S[0]);
C[16]=+V[35]*(32*V[35]-64*V[36])+32*S[0];
C[15]=+24*V[36]*V[35]*S[1]*S[4];
C[14]=+S[4]*(S[1]*(V[35]*(28*V[35]-40*V[36])+28*S[0]));
C[13]=+24*V[36]*V[35]*S[1];
C[12]=+S[1]*(V[35]*(28*V[35]-40*V[36])+28*S[0]);
C[11]=+V[35]*(16*V[35]-32*V[36])+16*S[0];
C[10]=+S[4]*(S[1]*(V[35]*(4*V[36]+14*V[35])+14*S[0]));
C[9]=+S[4]*(S[1]*(18*(S[0]+S[3])));
C[8]=+S[4]*(V[35]*(16*V[35]-32*V[36])+16*S[0]);
C[7]=+6*V[36]*V[35]*S[1]*S[2];
C[6]=+12*V[36]*V[35]*S[1]*S[4];
C[5]=+S[2]*(S[1]*(V[35]*(7*V[35]-10*V[36])+7*S[0]));
C[4]=+S[4]*(S[1]*(V[35]*(14*V[35]-20*V[36])+14*S[0]));
C[3]=+S[2]*(V[35]*(4*V[35]-8*V[36])+4*S[0]);
